...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in SecureGate, creating a new issue in the github repo
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   the repository in a concrete and reviewable manner.

## Asking for General Help

Because the level of activity in the  repository is so high,
questions or requests for general help using SecureGate should be directed by
email at `securegate2020labeip.epitech.eu`.

## Submitting a Bug Report

When opening a new issue in the repository issue tracker, users will be
...
This issue tracker is for bugs and issues found within SecureGate core.
If you require more general support please file an issue on our help
repo. https://github.com/atrahy/backend
...
If you believe that you have uncovered a bug in SecureGate, please fill out this
...
cases should be limited, as much as possible, to using *only* SecureGate APIs.
...
SecureGate changed that broke the module.
...
functional guidelines of the SecureGate project.
